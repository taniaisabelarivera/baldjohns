...
(3,  'Sunlight', 'Disposable Cigarette Lighter',       'Lighters contain butane and flint compounds that slowly release toxic heavy metals as they degrade.',                                                          80,   'https://xragmlmrgzsgbq5z.public.blob.vercel-storage.com/disposable-lighter.png'),
...
(6,  'Twilight', 'Lost Crab Pot (Ghost Trap)',         'Abandoned crab pots continue "ghost fishing," trapping and killing crustaceans indefinitely.',                                                                 350,  'https://xragmlmrgzsgbq5z.public.blob.vercel-storage.com/crab-trap.png'),
